...
*   **`removeNestedChildren(id: string, taskList: [TaskProps[]](../../types.md#taskprops))`**: Removes all direct children of the task with the given `id` from `taskList`. Uses `_.remove(taskList, (task) => task.parent === id);`.
